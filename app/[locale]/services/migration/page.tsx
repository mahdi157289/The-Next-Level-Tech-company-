...
import { CheckCircle2, Zap, Clock, ArrowRight, MousePointer2, Sparkles, Send, Layout, ShieldCheck, ArrowRightLeft, Rocket, Cloud } from 'lucide-react';
...
export default function MigrationServicePage() {
  const t = useTranslations('migrationService');
  ...
  const guideMessages = [
    "Phase 1: Auditing your legacy systems to identify hidden costs and bloat.",
    "Phase 2: Building your modern stack in a parallel shadow environment.",
    "Phase 3: Seamless zero-downtime switchover to your high-performance future."
  ];
              ...
              <div className="sidebar-content lg:sticky lg:top-24 lg:h-[calc(100vh-8rem)] flex flex-col justify-center relative pl-14 pr-8 py-12 bg-white/50 dark:bg-white/[0.02] backdrop-blur-xl border-r border-gray-100 dark:border-white/5 shadow-2xl dark:shadow-none rounded-r-[3rem] lg:rounded-none overflow-hidden">
                ...
                <div className="mb-10">
                  <div className="inline-flex items-center gap-2 text-indigo-500 mb-4">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.3em]">Migration Protocol</span>
                  </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-2 text-gray-400 dark:text-white/20">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest">Cloud Native</span>
                  </div>
                  <div className="flex items-center gap-2 text-indigo-500/50">
                    <Rocket className="h-3.5 w-3.5" />
                    <span className="text-[9px] font-black uppercase tracking-widest">Modern Stack</span>
                  </div>
                </div>
              </div>
            </aside>
