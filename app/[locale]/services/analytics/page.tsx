...
import { CheckCircle2, Zap, Clock, ArrowRight, MousePointer2, Sparkles, Send, Layout, ShieldCheck, BarChart3, LineChart, PieChart } from 'lucide-react';
...
export default function AnalyticsServicePage() {
  const t = useTranslations('dataService');
  ...
  const guideMessages = [
    "Phase 1: Identifying the core KPIs that drive your brand's success.",
    "Phase 2: Building interactive dashboards that visualize your real-time pulse.",
    "Phase 3: Launching your data-driven command center for absolute clarity."
  ];
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.to('.indicator-glow', {
        boxShadow: '0 0 30px rgba(8, 145, 178, 0.8)',
        duration: 1.5,
        repeat: -1,
        yoyo: true,
        ease: 'sine.inOut'
              ...
              <div className="sidebar-content lg:sticky lg:top-24 lg:h-[calc(100vh-8rem)] flex flex-col justify-center relative pl-14 pr-8 py-12 bg-white/50 dark:bg-white/[0.02] backdrop-blur-xl border-r border-gray-100 dark:border-white/5 shadow-2xl dark:shadow-none rounded-r-[3rem] lg:rounded-none overflow-hidden">
                ...
                <div 
                  ...
                  style={{
                    background: activePhase === 1 
                      ...
                      : 'radial-gradient(circle at 20% 50%, #0e7490 0%, transparent 70%)'
                  }}
                />
                ...
                <div className="mb-10">
                  <div className="inline-flex items-center gap-2 text-cyan-500 mb-4">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.3em]">Analytics Protocol</span>
                  </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 text-cyan-500/50">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest">Visual Insights</span>
                  </div>
                </div>
              </div>
            </aside>
